...
<div class="product-detail">
	...
	<div class="breadcrumb">
		<c:forEach var="category" items="${pdto.categoryDTOList}"
			varStatus="s">
			<button class="link-category"
	...
	<div class="product-main">
		...
		<div class="gallery">
			...
			<div class="main-image">
				<c:if test="${not empty pdto.imageDTOList}">
					<img id="mainProductImage" src="${pdto.imageDTOList[0].image_url}"
						alt="${pdto.productDTO.product_name}">
				</c:if>
			</div>
		...
		<div class="product-info">
			...
			<div class="brand">${pdto.productDTO.brand_name}</div>
			<div class="product-name">
				<h1 class="title">${pdto.productDTO.product_name}</h1>
			</div>

			<div class="price-box">
				<span class="discount"> ${pdto.productDTO.discount_rate}% </span> <span
					class="original-price"> <fmt:formatNumber
						value="${pdto.productDTO.original_price}" pattern="#,###" />원
				</span>

				<div>
					<span class="price"> <fmt:formatNumber
							value="${pdto.productDTO.price}" pattern="#,###" />원
					</span>
			...
			<div class="option-area">
				...
				<c:forEach var="option" items="${pdto.optionDTOList}">
					...
					<c:if test="${lastGroupId != option.option_group_id}">
						...
						<c:set var="lastGroupId" value="${option.option_group_id}" />

						<c:if test="${option.required == '1'}">

							<c:set var="requiredGroupCount" value="${requiredGroupCount + 1}" />
				...
				<span id="optionWarning"> 옵션을 선택해주세요 </span>

				<div id="selectedList"></div>

				<div class="total">
					<span>주문금액</span> <span id="totalPrice">0원</span>
				</div>
		...
		<div class="product-info-detail">
			<div class="tabs">
				<a class="active" href="#detail">상품정보</a> <a href="#detail-review">리뷰</a>
				<a href="#qna">문의</a> <a href="#delivery">배송/환불</a>
			</div>
			...
			<section id="detail-review" class="tab-content">
				<jsp:include page="/WEB-INF/views/product/review/reviewList.jsp">
					...
					<jsp:param name="member_id"
						value="${memberId != null ? memberId : 2}" />
				</jsp:include>
			</section>
